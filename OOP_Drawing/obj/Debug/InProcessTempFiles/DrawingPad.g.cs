...
namespace OOP_Drawing {
    ...
    public partial class DrawingPad : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(DrawingPad).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(DrawingPad));
        ...
        private string FindResource() {
            string[] resources = typeof(DrawingPad).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".DrawingPad.g.xaml") || resource.Equals("DrawingPad.g.xaml"))) {
                    return resource;
                }
            }
